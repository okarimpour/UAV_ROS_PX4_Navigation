...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.point_1.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.point_2.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.point_3.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.point_4.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.point_5.header.frame_id = str[start:end].decode('utf-8')
      else:
