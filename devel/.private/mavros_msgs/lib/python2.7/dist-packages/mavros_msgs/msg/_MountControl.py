...
"""autogenerated by genpy from mavros_msgs/MountControl.msg. Do not edit."""
import sys
...
class MountControl(genpy.Message):
  _md5sum = "214cf13a68b4fed9e2a77b1b436f144e"
  _type = "mavros_msgs/MountControl"
...
"""
  ...
  _slot_types = ['std_msgs/Header','uint8','float32','float32','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MountControl, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B6f().pack(_x.mode, _x.pitch, _x.roll, _x.yaw, _x.altitude, _x.latitude, _x.longitude))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode, _x.pitch, _x.roll, _x.yaw, _x.altitude, _x.latitude, _x.longitude,) = _get_struct_B6f().unpack(str[start:end])
      return self
