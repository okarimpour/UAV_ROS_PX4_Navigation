...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MountConfigure-request>)))
  ...
  (cl:format cl:nil "~%~%~%std_msgs/Header header~%~%uint8 mode~%~%uint8 MODE_RETRACT = 0~%uint8 MODE_NEUTRAL = 1~%uint8 MODE_MAVLINK_TARGETING = 2~%uint8 MODE_RC_TARGETING = 3~%uint8 MODE_GPS_POINT = 4~%~%bool stabilize_roll~%bool stabilize_pitch~%bool stabilize_yaw~%uint8 roll_input~%uint8 pitch_input~%uint8 yaw_input~%~%~%uint8 INPUT_ANGLE_BODY_FRAME = 0~%uint8 INPUT_ANGULAR_RATE = 1~%uint8 INPUT_ANGLE_ABSOLUTE_FRAME = 2~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MountConfigure-request)))
  "Returns full string definition for message of type 'MountConfigure-request"
  (cl:format cl:nil "~%~%~%std_msgs/Header header~%~%uint8 mode~%~%uint8 MODE_RETRACT = 0~%uint8 MODE_NEUTRAL = 1~%uint8 MODE_MAVLINK_TARGETING = 2~%uint8 MODE_RC_TARGETING = 3~%uint8 MODE_GPS_POINT = 4~%~%bool stabilize_roll~%bool stabilize_pitch~%bool stabilize_yaw~%uint8 roll_input~%uint8 pitch_input~%uint8 yaw_input~%~%~%uint8 INPUT_ANGLE_BODY_FRAME = 0~%uint8 INPUT_ANGULAR_RATE = 1~%uint8 INPUT_ANGLE_ABSOLUTE_FRAME = 2~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
