...
class FileCloseRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FileCloseRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new FileCloseRequest(null);
...
class FileCloseResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FileCloseResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new FileCloseResponse(null);
...
module.exports = {
  ...
  datatype() { return 'mavros_msgs/FileClose'; }
};
