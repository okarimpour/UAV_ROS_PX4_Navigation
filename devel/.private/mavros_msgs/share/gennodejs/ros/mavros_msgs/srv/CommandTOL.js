...
class CommandTOLRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommandTOLRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandTOLRequest(null);
...
class CommandTOLResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CommandTOLResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new CommandTOLResponse(null);
...
module.exports = {
  ...
  md5sum() { return '93ff4eaa9907f58c0e7a909cddce23e2'; },
  datatype() { return 'mavros_msgs/CommandTOL'; }
};
