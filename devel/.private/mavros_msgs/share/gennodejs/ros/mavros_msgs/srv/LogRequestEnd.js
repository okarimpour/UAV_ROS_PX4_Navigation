...
class LogRequestEndRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LogRequestEndRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LogRequestEndRequest(null);
    return resolved;
    }
};

class LogRequestEndResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LogRequestEndResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LogRequestEndResponse(null);
...
module.exports = {
  ...
  datatype() { return 'mavros_msgs/LogRequestEnd'; }
};
