...
if("TRUE" STREQUAL "TRUE")
  set(px4_SOURCE_PREFIX /home/omid/catkin_ws/src/Firmware)
  set(px4_DEVEL_PREFIX /home/omid/catkin_ws/devel/.private/px4)
  set(px4_INSTALL_PREFIX "")
  set(px4_PREFIX ${px4_DEVEL_PREFIX})
else()
  set(px4_SOURCE_PREFIX "")
  set(px4_DEVEL_PREFIX "")
  set(px4_INSTALL_PREFIX /home/omid/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'px4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/omid/catkin_ws/src/Firmware/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT px4_NUM_DUMMY_TARGETS)
      set(px4_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::px4::wrapped-linker-option${px4_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR px4_NUM_DUMMY_TARGETS "${px4_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::px4::wrapped-linker-option${px4_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND px4_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/omid/catkin_ws/devel/.private/px4/lib;/home/omid/catkin_ws/devel/lib;/home/omid/UAV_ROS_PX4_Navigation/devel/lib;/opt/ros/melodic/lib)
